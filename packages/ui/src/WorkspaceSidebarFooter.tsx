/* oxlint-disable eslint(max-lines) -- footer 聚合主题、语言、界面模式和快捷键菜单。 */
...
/**
 * 侧边栏页脚偏好入口。
 * 账号头像、登录/登出与套餐余量随登录一并移除，这里只保留本地偏好与设置页入口。
 */
export const WorkspaceSidebarFooter = memo(function WorkspaceSidebarFooterComponent({
  ...
  const preferencesLabel = intl.formatMessage({ id: "sidebar.preferences" });
