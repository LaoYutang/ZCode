...
const enUS: Record<string, string> = {
  ...
  "sidePane.usage": "Usage details",
  "sidePane.usageRetention": "Range: last {days} days",
  "sidePane.usageToday": "Today (all sessions)",
  "sidePane.usageByModel": "By model",
  "sidePane.usageTools": "Tool calls",
  "sidePane.usageSubagents": "Subagents",
  "sidePane.usageSubagentTotal": "Subagent total",
  "sidePane.usageRecent": "Recent requests",
  "sidePane.usageColumnInput": "Input",
  "sidePane.usageColumnOutput": "Output",
  "sidePane.usageColumnTotal": "Total",
  "sidePane.usageColumnRequests": "Requests",
  "sidePane.usageRequests": "{count} requests",
  "sidePane.usageToolErrors": "{count} errors",
  "sidePane.usageEmpty": "No usage recorded for this session",
  "sidePane.usageNoTools": "No tool calls",
  "sidePane.usageNoSubagents": "No subagent usage",
  "sidePane.usageLoadFailed": "Failed to load session usage",
  "sidePane.usageUnsupported": "This version does not support session usage details",
  ...
  "chat.statusPanel.openUsage": "Open usage details",
