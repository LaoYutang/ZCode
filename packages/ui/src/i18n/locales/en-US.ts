...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like ZCode-Lite to show its work?",
  ...
  "occupationOnboarding.memoryDescription":
    "Let ZCode-Lite remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting ZCode-Lite",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen ZCode-Lite.",
  ...
  "startup.global.starting_services": "Starting ZCode-Lite",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "ZCode-Lite will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another ZCode-Lite or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen ZCode-Lite. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen ZCode-Lite to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen ZCode-Lite.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a ZCode-Lite restart to take effect.",
  ...
  "quickPick.command.addProvider": "Add provider",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to ZCode-Lite",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to ZCode-Lite",
  "login.description": "Connect your account to start using ZCode-Lite",
  ...
  "logout.confirm.title": "Disconnect and restart ZCode-Lite?",
  ...
  "sidePane.usageSubagentTotal": "Subagent total",
  ...
  "titleBar.menu.help.about": "About ZCode-Lite",
  "about.dialog.versionLabel": "version",
  "about.dialog.copyright": "Copyright © {year} ZCode-Lite.",
  "about.dialog.optimizedForAppleSilicon": "Optimized for Apple Silicon.",
  "about.dialog.okButton": "OK",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart ZCode-Lite to continue.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "ZCode-Lite checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the ZCode-Lite terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While ZCode-Lite is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the ZCode-Lite installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching ZCode-Lite task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by ZCode-Lite",
  ...
  "resourceManager.storage.diskUsage": "ZCode-Lite uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the ZCode-Lite desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZCode-Lite could not verify its Windows secure import component. Reinstall or update ZCode-Lite before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, ZCode-Lite will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.host.activeDescription":
    "ZCode-Lite provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This ZCode Agent cannot refresh OAuth status. Upgrade or restart ZCode-Lite, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to ZCode-Lite to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into ZCode-Lite",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by ZCode-Lite automatically.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. ZCode-Lite uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in ZCode-Lite after purchase or setup.",
  ...
  "sidebar.usage.plan.zcodeMcpDescription":
    "Daily aggregate quota for ZCode-Lite built-in plugin MCPs",
  ...
  "settings.usage.summaryTitle": "All-time overview",
  "settings.usage.summaryRetentionHint": "Only the last 30 days are kept locally",
  "settings.usage.todayTitle": "Today",
  "settings.usage.todayTotalTokens": "Total tokens",
  "settings.usage.todayInputTokens": "Input",
  "settings.usage.todayOutputTokens": "Output",
  "settings.usage.todayCacheReadTokens": "Cached input",
  "settings.usage.todayCacheCreationTokens": "Cache write",
  "settings.usage.todayRequests": "Requests",
  "settings.usage.todayToolCalls": "Tool calls",
  "settings.usage.todayUnavailable": "This version does not return today's usage; update to see it",
  ...
  "settings.modelProvider.empty":
    "No providers yet. Use “Add provider” to enter a base URL and API key.",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into ZCode-Lite. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. ZCode-Lite follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into ZCode-Lite",
  ...
  "settings.plugins.store.subtitle":
    "Extend ZCode-Lite with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into ZCode-Lite and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. ZCode-Lite follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into ZCode-Lite",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into ZCode-Lite. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. ZCode-Lite follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into ZCode-Lite",
  ...
  "settingsSync.action.finish": "Start using ZCode-Lite",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current ZCode-Lite settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to ZCode-Lite",
  ...
  "onboarding.welcome.title": "Welcome to ZCode-Lite",
  "onboarding.welcome.start": "Start ZCode-Lite",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while ZCode-Lite imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "ZCode-Lite will copy {source} to {target}.\nIf the target file already exists, the ZCode-Lite default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask ZCode-Lite anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask ZCode-Lite anything…",
  ...
  "chat.statusPanel.usage": "Usage",
  "chat.statusPanel.usageSpeed": "Speed",
  "chat.statusPanel.usageFirstToken": "First token",
  "chat.statusPanel.usageTotal": "Session total",
  "chat.statusPanel.usageUnavailable": "Usage unavailable",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, ZCode-Lite will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want ZCode-Lite to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart ZCode-Lite app and retry, or ask ZCode-Lite to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with ZCode-Lite in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for ZCode-Lite: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with ZCode-Lite in chat and save a new version.",
  ...
  "chat.error.copyFull.heading": "ZCode-Lite Error Info",
  "chat.error.copyFull.summary": "Error Summary",
  "chat.error.copyFull.detail": "Error Details",
  "chat.error.copyFull.traceId": "TraceID: {traceId}",
  ...
  "resourceManager.appUsage": "ZCode-Lite",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while ZCode-Lite is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task ZCode-Lite can work on in the background, including the expected result and any constraints…",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart ZCode-Lite",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart ZCode-Lite to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified ZCode-Lite plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "ZCode-Lite will verify the Computer Use tools against the exact session when your first session starts.",
