...
const zhCN: Record<string, string> = {
  ...
  "sidePane.usage": "用量明细",
  "sidePane.usageRetention": "统计范围：近 {days} 天",
  "sidePane.usageToday": "今日（全部会话）",
  "sidePane.usageByModel": "按模型",
  "sidePane.usageTools": "工具调用",
  "sidePane.usageSubagents": "子代理",
  "sidePane.usageSubagentTotal": "子代理合计",
  "sidePane.usageRecent": "最近请求",
  "sidePane.usageColumnInput": "输入",
  "sidePane.usageColumnOutput": "输出",
  "sidePane.usageColumnTotal": "合计",
  "sidePane.usageColumnRequests": "请求",
  "sidePane.usageRequests": "{count} 次请求",
  "sidePane.usageToolErrors": "{count} 次错误",
  "sidePane.usageEmpty": "本会话暂无用量记录",
  "sidePane.usageNoTools": "无工具调用",
  "sidePane.usageNoSubagents": "无子代理用量",
  "sidePane.usageLoadFailed": "读取会话用量失败",
  "sidePane.usageUnsupported": "当前版本不支持会话用量明细，请更新后重试",
  ...
  "chat.statusPanel.openUsage": "打开用量明细",
