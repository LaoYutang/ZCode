...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 ZCode-Lite 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 ZCode-Lite 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 ZCode-Lite 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 ZCode-Lite",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 ZCode-Lite。",
  ...
  "startup.global.starting_services": "正在启动 ZCode-Lite",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 ZCode-Lite。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "startup.global.error.lock_timeout":
    "等待数据库写锁超时。请检查其他 ZCode-Lite 或 CLI 进程是否仍在更新数据，待其完成后点击重试。",
  "startup.global.error.sql_failed":
    "准备过程未完成。请复制诊断信息查看日志，排除问题后手动重试。应用不会自动重试。",
  "startup.global.error.startup_status_timeout":
    "未能收到启动状态。请退出并重新打开 ZCode-Lite；如果仍失败，请提供诊断信息。",
  "startup.global.error.transport_closed":
    "数据准备进程意外退出或连接中断。请退出并重新打开 ZCode-Lite，应用会重新检查迁移记录。",
  "startup.global.error.unsupported_runtime":
    "当前配置的 Agent 不支持独立存储准备。请恢复配套的 Agent 后重新打开 ZCode-Lite。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 ZCode-Lite 后生效。",
  ...
  "quickPick.command.addProvider": "添加供应商",
  ...
  "login.title": "欢迎来到 ZCode-Lite",
  "login.description": "连接账号，开始使用 ZCode-Lite",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 ZCode-Lite？",
  ...
  "sidePane.usageSubagentTotal": "子代理合计",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 ZCode-Lite 即可继续使用。",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 ZCode-Lite 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 ZCode-Lite 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 ZCode-Lite 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 ZCode-Lite 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "ZCode-Lite 总占用",
  ...
  "resourceManager.storage.diskUsage": "ZCode-Lite 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 ZCode-Lite 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZCode-Lite 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 ZCode-Lite。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 ZCode-Lite 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 ZCode Agent 不支持 OAuth 状态刷新。请升级或重启 ZCode-Lite，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 ZCode-Lite。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 ZCode-Lite",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 ZCode-Lite 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.customTitle": "供应商",
  ...
  "settings.modelProvider.empty":
    "还没有供应商，点击右上角「添加供应商」填写 Base URL 与 API Key。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 ZCode-Lite 即可继续编码。",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "ZCode-Lite 预置插件 MCP 每日合计额度",
  ...
  "settings.usage.summaryTitle": "累计概览",
  "settings.usage.summaryRetentionHint": "本地只保留近 30 天记录",
  "settings.usage.todayTitle": "今日用量",
  "settings.usage.todayTotalTokens": "Token 总量",
  "settings.usage.todayInputTokens": "输入",
  "settings.usage.todayOutputTokens": "输出",
  "settings.usage.todayCacheReadTokens": "命中缓存",
  "settings.usage.todayCacheCreationTokens": "写入缓存",
  "settings.usage.todayRequests": "请求次数",
  "settings.usage.todayToolCalls": "工具调用",
  "settings.usage.todayUnavailable": "当前版本不返回今日用量，请更新后重试",
  ...
  "settings.plugins.store.subtitle": "用插件为 ZCode-Lite 扩展技能、命令与 MCP 能力",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 ZCode-Lite 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 ZCode-Lite",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 ZCode-Lite",
  "onboarding.welcome.start": "开始使用 ZCode-Lite",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 ZCode-Lite 完成导入。",
  ...
  "chat.placeholder.newTask": "向 ZCode-Lite 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 ZCode-Lite 提问…",
  ...
  "chat.statusPanel.usage": "用量",
  "chat.statusPanel.usageSpeed": "速度",
  "chat.statusPanel.usageFirstToken": "首字延迟",
  "chat.statusPanel.usageTotal": "会话合计",
  "chat.statusPanel.usageUnavailable": "用量不可查",
  ...
  "chat.toolbar.computerUse.tooltip.ready": "电脑操作已就绪 · 直接描述你想让 ZCode-Lite 做的事",
  "chat.toolbar.computerUse.tooltip.permissionRequired": "缺少 macOS 权限，点击完成授权",
  "chat.toolbar.computerUse.tooltip.error":
    "电脑操作启用失败 · 重启 ZCode-Lite 应用后重试，或让 ZCode-Lite 排查日志",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 ZCode-Lite 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 ZCode-Lite 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 ZCode-Lite 修订后另存一版。",
  ...
  "chat.error.copyFull.heading": "ZCode-Lite 报错信息",
  "chat.error.copyFull.summary": "报错摘要",
  "chat.error.copyFull.detail": "报错详情",
  ...
  "offPeak.keepAwakeBanner": "ZCode-Lite 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 ZCode-Lite 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 ZCode-Lite",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 ZCode-Lite 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 ZCode-Lite 官方插件。请检查插件安装后重新验证。",
