...
ZCode-Lite is a desktop-first and web-compatible AI workspace. The interface should feel calm, dense, and operational rather than decorative.
...
ZCode-Lite should use restrained depth. Layer primarily through background contrast, borders, and radius before relying on heavy shadows.
