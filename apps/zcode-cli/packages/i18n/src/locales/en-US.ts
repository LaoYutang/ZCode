...
`,
  ...
  tui: {
    ...
    loginRequired: {
      help: "Add a provider in the model settings to make models selectable.",
      message: "No available models. Add a provider to continue.",
      status: "No available models. Add a provider to continue.",
    ...
    terminal: {
      ...
      starting: "Starting ZCode-Lite... Ctrl+C to exit",
    },
    transcript: {
      compact: {
